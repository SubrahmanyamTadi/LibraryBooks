...
<body>
    ...
    <div class="container"> 
        <form method="post" action="/book/savebook">
            <div class="form-group">
                <label>Book ISBN:</label>
                <div class="input-group">
                    <span class="input-group-text"><i class="fas fa-book"></i></span>
                    <input type="text" class="form-control" name="isbn" placeholder="Enter Book ISBN" value="${book.isbn}"/><br>
                    </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <span class="input-group-text"><i class="fas fa-book"></i></span>
                    <input type="text" class="form-control" name="bookname" placeholder="Enter Book name" value="${book.bookname}"/><br>
                    </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="author" placeholder="Enter Author name" value="${book.author}"/><br>
                    </div>
